...
func InitData() {
	...
	systemUserStr := "/system_admin/user"
	userStr := "user"
	peoplesStr := "peoples"
	...
	menus := []model.Menu{
		...
		},
		{
			...
			Icon:      &userStr,
			Path:      "user",
			Component: "/system_admin/user/index",
			Sort:      11,
			ParentId:  &uint1,
			Roles:     roles[:1],
			Creator:   "系统",
		},
		{
			...
			Icon:      &peoplesStr,
			Path:      "role",
			Component: "/system_admin/role/index",
			Sort:      12,
			ParentId:  &uint1,
			Roles:     roles[:1],
			Creator:   "系统",
		},
		{
			...
			Icon:      &treeTableStr,
			Path:      "menu",
			Component: "/system_admin/menu/index",
			Sort:      13,
			ParentId:  &uint1,
			Roles:     roles[:1],
			Creator:   "系统",
		},
		{
			...
			Icon:      &treeStr,
			Path:      "api",
			Component: "/system_admin/api/index",
			Sort:      14,
			ParentId:  &uint1,
			Roles:     roles[:1],
			Creator:   "系统",
